...
import { MAX_ZIP_SIZE, REPLACE_SYMBOL } from "@/core/constants"
import { readToPath, get3xSingleFilePath, getProjectBuildPath, writeToPath, copyDirToPath, getOriginPkgPath, replaceGlobalSymbol, rmSync } from "@/core/utils"
import { injectFromRCJson } from "@/core/helpers/dom"
